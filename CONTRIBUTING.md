...
Report bugs at https://github.com//netbox-zabbix/issues.
...
NetBox Zabbix Plugin could always use more documentation, whether as part of the
official NetBox Zabbix Plugin docs, in docstrings, or even on the web in blog posts,
articles, and such.

### Submit Feedback

The best way to send feedback is to file an issue at https://github.com//netbox-zabbix/issues.
...
3. The pull request should work for Python 3.8, 3.9, 3.10 and 3.11. Check
   https://github.com//netbox-zabbix/actions
